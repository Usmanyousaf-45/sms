...
// =============================================================================
// ICON SYSTEM
// Hand-rolled SVG icon set (no lucide/react-icons per project constraints).
// Every icon is a simple stroked path at 24x24 viewBox for visual consistency.
// Add new keys here as modules need them — this is the single icon surface
// for the entire app.
// =============================================================================

export type IconName =
  | "grid" | "users" | "userGroup" | "userPlus" | "briefcase" | "layers"
  | "checkSquare" | "calendar" | "award" | "bookOpen" | "clipboard"
  | "graduationCap" | "helpCircle" | "creditCard" | "book" | "truck"
  | "home" | "wallet" | "box" | "star" | "megaphone" | "messageCircle"
  | "barChart" | "sparkles" | "settings" | "search" | "bell" | "sun" | "moon"
  | "chevronDown" | "chevronRight" | "chevronLeft" | "chevronUp" | "x"
  | "plus" | "edit" | "trash" | "eye" | "filter" | "download" | "upload"
  | "check" | "checkCircle" | "alertCircle" | "alertTriangle" | "info"
  | "arrowRight" | "arrowLeft" | "arrowUpRight" | "logOut" | "mail"
  | "phone" | "mapPin" | "lock" | "user" | "menu" | "more" | "clock"
  | "trendingUp" | "trendingDown" | "dollarSign" | "fileText" | "send"
  | "play" | "pause" | "video" | "link" | "paperclip" | "flag" | "target"
  | "zap" | "shield" | "refreshCw" | "printer" | "share" | "copy" | "pin"
  | "bus" | "bed" | "package" | "activity" | "pieChart" | "list" | "grid3x3"
  | "smile" | "thumbsUp" | "cpu" | "wifi" | "globe" | "camera" | "image"
  | "minus" | "externalLink" | "loader" | "gift" | "heart" | "bookmark";
...
const PATHS: Record<IconName, string> = {
  ...
  userGroup: "M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2 M9 11a4 4 0 1 0 0-8 4 4 0 0 0 0 8z M23 21v-2a4 4 0 0 0-3-3.87 M16 3.13a4 4 0 0 1 0 7.75",
  userPlus: "M16 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2 M9 11a4 4 0 1 0 0-8 4 4 0 0 0 0 8z M19 8v6 M22 11h-6",
  briefcase: "M20 7h-3V5a2 2 0 0 0-2-2H9a2 2 0 0 0-2 2v2H4a1 1 0 0 0-1 1v11a1 1 0 0 0 1 1h16a1 1 0 0 0 1-1V8a1 1 0 0 0-1-1zM9 7V5h6v2 M3 12h18",
  layers: "M12 2 2 7l10 5 10-5-10-5zM2 17l10 5 10-5 M2 12l10 5 10-5",
  ...
  graduationCap: "M22 10 12 5 2 10l10 5 10-5zM6 12v5c0 1 3 3 6 3s6-2 6-3v-5 M22 10v6",
  helpCircle: "M12 22a10 10 0 1 0 0-20 10 10 0 0 0 0 20zM9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3 M12 17h.01",
  ...
  wallet: "M21 12V7a2 2 0 0 0-2-2H5a2 2 0 0 0-2 2v10a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-5h-4a2 2 0 1 1 0-4h4z",
  ...
  sparkles: "m12 3-1.5 4.5L6 9l4.5 1.5L12 15l1.5-4.5L18 9l-4.5-1.5L12 3z M5 3v4M3 5h4M19 17v4M17 19h4",
  ...
  share: "M4 12v8a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2v-8 M16 6l-4-4-4 4M12 2v13",
  ...
  pin: "M12 17v5 M9 10.76a3 3 0 1 1 4.87-2.35c0 2.35-2.44 3-2.44 5.59H10.5c0-2.14-2-2.9-2-5.24z M5 10.76c0-3.87 3.13-7 7-7s7 3.13 7 7c0 1.5-.5 2.5-1 3.24l-6 8-6-8c-.5-.74-1-1.74-1-3.24z",
  bus: "M4 6a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v11a1 1 0 0 1-1 1H5a1 1 0 0 1-1-1zM4 12h16 M7.5 20.5a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3zM16.5 20.5a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3z",
  ...
  minus: "M5 12h14",
  externalLink: "M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6 M15 3h6v6M10 14 21 3",
